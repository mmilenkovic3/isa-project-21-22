 ...
 <!--<select v-model="reservationType" id="reservationType" class="form-control" 
    ...
    <div class="container">
        ...
        <!-- POCETAK COL ZA BOAT-->
                <div class="col">
                        <h4> Boat: </h4>
                        <p v-show="this.ActionBoats.length == 0"> Boat for cottage doesn't exists. </p>
                        <table class="table"
                        style="border: 1px solid black"
...
export default{
    ...
    {       
      getActions: function()
      {
        this.axios.post('/action/getAllAction', {
                    headers: 
                    {
      ...
      {
        this.axios.post('/action/getAllBoatAction', {
                    headers: 
                    {
                        'Authorization': `Bearer ` + localStorage.getItem('accessToken')
      ...
      {
        this.axios.post('/action/getAllAdventureAction', {
                            headers: 
                            {
                                'Authorization': `Bearer ` + localStorage.getItem('accessToken')
